...
USE_ALL_TESTCASES=1
WEBPORT=80
# eg, ".icpc-vcss.org", or empty if local
HOSTDOMAIN=""
...
TableRow()
{
	...
	echo '  {'
	echo '   "runid":"'$runid'"',
	echo '   "href":"http://'$hostname:$WEBPORT'/cgi-bin/showrun.sh?run='$runid'&dir='$dir'&probdir='$probdir'&probletter='$problet'&probshort='$shortname'&lang='$langid'&submitter='$teamnum'&judgment='$judgment'"',
